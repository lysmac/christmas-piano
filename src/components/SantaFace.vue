...
<template>
  ...
  >
    <g>
      <path
        fill="green"
        d="M17.5,20.3C17.1,20.8,16.6,21,16,21c-0.6,0-1,0.4-1,1s0.4,1,1,1c1.1,0,2.2-0.5,3-1.3c0.4-0.4,0.3-1-0.1-1.4
		C18.5,19.9,17.8,19.9,17.5,20.3z"
      />
      <path
        :fill="fillColor"
        d="M27,8c2.2,0,4-1.8,4-4s-1.8-4-4-4c-1.4,0-2.7,0.8-3.4,1.9l-4.2-1.3c-1.6-0.5-3.3-0.5-4.9,0.1C11.8,1.7,9.8,4,9.2,6.8l0,0.2
      ...
      <g fill="yellow">
        <path
          d="M13.1,16.4c0,0.1,0.1,0.1,0.1,0.2c0,0,0.1,0.1,0.1,0.1c0.2,0.2,0.4,0.3,0.7,0.3c0.1,0,0.3,0,0.4-0.1
        ...
        />
        <path
          d="M18,17c0.1,0,0.3,0,0.4-0.1c0.1-0.1,0.2-0.1,0.3-0.2c0.2-0.2,0.3-0.5,0.3-0.7c0-0.1,0-0.3-0.1-0.4
